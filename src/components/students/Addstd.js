...
function Addstd() {
    ...
    return (
        <div className="addForm" style={{width:"40%",margin:"4rem auto",padding:"20px",borderRadius:"8px",backgroundColor:" aliceblue"}}>
        {/* First Name, Last Name, Grade, Date of Birth, Gender, Email, Phone, Address */}
        <h2>Add Details</h2>
